...
/*   Updated: 2015/10/22 02:19:23 by vmonteco         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				uf_test_strlcat(void)
{
	...
	ft_putstr("dest : ");
	ft_putendl(dest);
	ft_putstr("dest length : ");
	ft_putnbr(ft_strlen(dest));
	ft_putchar('\n');
	ft_putstr("strlcat result : ");
	ft_putendl(ft_itoa((int) strlcat(dest, "Hello ", 4)));
	ft_putstr("dest after : ");
	ft_putendl(dest);
	ft_putstr("dest2 : ");
	ft_putendl(dest2);
	ft_putstr("ft_strlcat result : ");
	ft_putendl(ft_itoa((int) ft_strlcat(dest2, "Hello ", 4)));
	ft_putstr("dest2 after : ");
	ft_putendl(dest2);
